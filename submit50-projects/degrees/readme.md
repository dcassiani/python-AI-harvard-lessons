...
**Transcript**: [https://cs50.harvard.edu/ai/2024/projects/0/degrees/](https://cs50.harvard.edu/ai/2024/projects/0/degrees/)  
**Lesson**: [https://cs50.harvard.edu/ai/2024/weeks/0/](https://cs50.harvard.edu/ai/2024/weeks/0/)  
**Project YML**: [https://raw.githubusercontent.com/ai50/projects/2024/x/degrees/.cs50.yml](https://raw.githubusercontent.com/ai50/projects/2024/x/degrees/.cs50.yml)  
...
By **Wednesday, December 31, 2025 at 8:59 PM GMT-3**
...
- To evaluate the correctness of your code (optional):
```bash
...
> Remember: only use authorized standard libraries. Unauthorized imports will break `check50` and `submit50`.

---

## How to Submit

1. Visit the link, log in with your GitHub account, and click **Authorize cs50**.
2. Check the box to grant course staff access, and click **Join course**.
3. Install Git and optionally `submit50`.
4. Submit with:
...
Or, if using Git manually, push to:

```
https://github.com/me50/USERNAME.git (branch: ai50/projects/2024/x/degrees)
```

> ⚠️ Do **not** include the `large` or `small` directories. `submit50` will ignore them automatically.
